...
export const products: Product[] = [
  // Bouquets
  { id: 'colore', name: 'Le Coloré', price: 30, image: '/images/produit-colore.jpg', category: 'Bouquets', description: 'Un bouquet vibrant aux couleurs éclatantes, composé de fleurs de saison soigneusement sélectionnées. Idéal pour égayer une pièce ou surprendre vos proches.' },
  { id: 'intemporel', name: "L'Intemporel", price: 30, image: '/images/produit-intemporel.jpg', category: 'Bouquets', description: 'La sobriété élégante d\'un bouquet classique. Des fleurs blanches et crèmes qui traversent le temps avec grâce. Un cadeau toujours juste.' },
  { id: 'pastel', name: 'Le Pastel', price: 30, image: '/images/produit-pastel.jpg', category: 'Bouquets', description: 'Douceur et délicatesse dans un bouquet aux teintes pastels. Roses poudré, lilas, crème — pour les instants de tendresse.' },
  { id: 'audacieux', name: "L'Audacieux", price: 30, image: '/images/produit-audacieux.jpg', category: 'Bouquets', description: 'Pour les amateurs d\'originalité. Un bouquet structuré, aux associations inattendues et aux textures contrastées.' },
  // Plantes
  ...
  { id: 'plante-verte', name: 'La Plante Verte', price: 30, image: '/images/produit-plante-verte.jpg', category: 'Plantes', description: 'Epurée et contemporaine, cette plante verte s\'intègre dans tous les intérieurs. Sélectionnée pour sa robustesse et son esthétique.' },
